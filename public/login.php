...
<body>
    ...
    <div class=" w-screen h-screen p-4 flex items-center justify-center gap-4">
        <div class=" hidden md:flex h-full items-center justify-center">
            <img src="./assets/sign-in.webp" alt="">
        </div>
        <div class=" w-full md:w-[500px] p-4 bg-white rounded-lg shadow-md flex-none">
            ...
            <form action="" method="post">
                <div class=" flex flex-col items-start gap-1 my-2">
                    <label for="email_username" class=" text-sm font-semibold text-gray-600">Email or Username</label>
                    <input type="text" name="email_username" id="email_username" class=" w-full rounded-md py-2 px-4 border-2 border-gray-400 outline-none focus:border-app-primary">
                </div>
                <!--  -->
                <div class=" flex flex-col items-start gap-1 my-2">
